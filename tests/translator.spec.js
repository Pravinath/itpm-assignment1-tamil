...
const POSITIVE = [
  ...
  { id: "Pos_Fun_0005", name: "Negation", input: "naan varalavillai.", len: "S" },
  ...
  { id: "Pos_Fun_0009", name: "Plural", input: "pillaikal paadasalaikku selkindrarkal.", len: "M" },
  { id: "Pos_Fun_0010", name: "Compound", input: "naan veetukku pogavendum, aanal mazhai varukidrathu.", len: "M" },
  ...
  { id: "Pos_Fun_0013", name: "Repeated words", input: "seri seri. Naan varugindren", len: "S" },
  { id: "Pos_Fun_0014", name: "Numbers/currency", input: "naan indaikku Rs 30500 selavu panninen", len: "M" },
  { id: "Pos_Fun_0015", name: "Date/time", input: "exam January 25 date la 7:30A.M manikku nadakkum", len: "M" },
  { id: "Pos_Fun_0016", name: "Multiple spaces", input: "naan paadasalaikku pogavillai.", len: "S" },
  ...
  { id: "Pos_Fun_0019", name: "Punctuation mark", input: "teacher 'amaithiyaga irunga' endru sonnanga", len: "M" },
  { id: "Pos_Fun_0020", name: "Negation", input: "Enakku athu veaendaam", len: "S" },
  ...
  { id: "Pos_Fun_0023", name: "Apology", input: "mannichidu.", len: "S" },
  {
    ...
    name: "Long paragraph",
    input:
      "indaikku naan veliyila poyittu vandhen traffic rommba irunthichi appuram meeting la project update sonnen , appuram veettukku pogum poothu mazhai peithichu aana veettukku paththirama veettukku vanthutten.",
    len: "L",
  },
];

const NEGATIVE = [
  { id: "Neg_Fun_0001", name: "Informal", input: "nee varuviya illaya sollu da fasta", len: "M" },
  { id: "Neg_Fun_0002", name: "Missing spaces", input: "naankadailku poren ", len: "S" },
  { id: "Neg_Fun_0003", name: "Slang", input: "dei machan semma bored da", len: "S" },
  { id: "Neg_Fun_0004", name: "Extra spaces", input: "naan    veetuku         poren", len: "S" },
  { id: "Neg_Fun_0005", name: "Symbols", input: "naalaiku 7pm ku meet pannalaam #urgent @home", len: "M" },
  { id: "Neg_Fun_0006", name: "Abbreviations", input: " OTP vandha apram SMS check panni anuppu ASAP venum.", len: "M" },
  { id: "Neg_Fun_0007", name: "Mixed English", input: "indaikku assignment submit pannitu, mail check panni confirm pannunga", len: "M" },
  {
    id: "Neg_Fun_0008",
    name: "Repeated slang",
    input: "romba romba romba mokka da, semma bore aaguthu" + "nandri".repeat(10),
    len: "L",
  },
  { id: "Neg_Fun_0009", name: "Typo causes", input: "naan poyttu vaarrn", len: "S" },
  { id: "Neg_Fun_0010", name: "Informal sentence", input: "indaikku office la romba pressure. morningla irunthu continuous meetings, apram client call, appuram report panna sonnaanga. lunch kooda  saapdala. evening varaikum mind fulla tension. ", len: "M" },
];
